            ...
            */
            ...
            public void BasicDroneHoverAndRotation()
            {
                ...
                droneObject.localRotation = Quaternion.Euler(
                    new Vector3(10, 0, tiltAmountSideways)
                );
            }
            ...
            {
                idle = false;
                upForce = forceUpHover * floating.Vertical*upSpeed;/* 9.81003f*/; //450

               
            }
            //public VariableJoystick variableJoystick;
            public FloatingJoystick floating;
            ...
            public void Rotation()
            {
                ...
                Debug.Log("wantedYRotation" + wantedYRotation);
            ...
            {
                ourDrone.AddRelativeForce(Vector3.forward * forwardSpeed * movementForwardSpeed);
