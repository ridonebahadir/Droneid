        ...
        public class CameraScript : MonoBehaviour
        {
            ...
            */
            ...
            void FreeMouseMovementView()
            {
                ...
                {
					if (pickedMyDrone && ourDrone)
						transform.rotation = Quaternion.Euler(new Vector3(27 + cameraYVelocity, ourDrone.transform.rotation.eulerAngles.y, 0));
                    else if (pickedMyDrone == false && dronesToControl.Length > 0)
                        transform.rotation = Quaternion.Euler(new Vector3(27, dronesToControl[counterToControl].transform.rotation.eulerAngles.y, 0));
                }
            }
